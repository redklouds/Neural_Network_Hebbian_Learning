...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function result = trainNetwork_Hebb(P)
    %function used to train the neural network using Hebbian learning Rules
    global weights_Hebb;
    %where P is a matrix such as pq and pn are row vectors
    %then, 
    %P = [tranpose(pq) transpose(pn)..]
    %step 3 making T
    T = P; %SET T = P
    %Hebbian learning rule
    weights_Hebb = T * transpose(P);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% -Function:
% -Description:
...
%     results6px 
    ...
    title("Hebbian Learning Rule, Performance metrics");
